...
aws s3 cp $code_home/angular/SeerlogicsBotAdminUI/main-app/dist s3://gab.seersense.com --profile bizBotAdmin --grants read=uri=http://acs.amazonaws.com/groups/global/AllUsers --recursive
