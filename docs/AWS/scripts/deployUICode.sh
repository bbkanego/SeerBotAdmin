...
aws s3 cp $botAdminUI/main-app/dist s3://gabadmin.seersense.com --profile bizBotAdmin --grants read=uri=http://acs.amazonaws.com/groups/global/AllUsers --recursive
