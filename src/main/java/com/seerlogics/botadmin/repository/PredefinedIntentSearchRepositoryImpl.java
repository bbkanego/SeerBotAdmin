 ...
 */
@Repository
public class PredefinedIntentSearchRepositoryImpl implements PredefinedIntentSearchRepository {
    private EntityManager em;

    public PredefinedIntentSearchRepositoryImpl(EntityManager em) {
        this.em = em;
    }
